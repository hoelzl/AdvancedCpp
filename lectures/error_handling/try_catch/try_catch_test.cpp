...
TEST_CASE("TryCatch, ComputeSum_ComputesSumOfArguments")
{
...
TEST_CASE("TryCatch, ComputeSqrt_Computesresult_WhenCalledWithZeroArg")
{
...
TEST_CASE("TryCatch, ComputeSqrt_Computesresult_WhenCalledWithPositiveArg")
{
...
TEST_CASE("TryCatch, ComputeSqrt_Throws_WhenCalledWithNegativeArg")
{
    CHECK_THROWS_AS(compute_sqrt(-4.0), std::out_of_range);
}


TEST_CASE("TryCatch, AllocateDoubleArray_ReturnsArray_WhenArgsAreValid")
{
...
TEST_CASE("TryCatch, AllocateDoubleArray_Throws_WhenArgsAreInvalid")
{
    CHECK_THROWS_AS(allocate_double_array(200), std::bad_alloc);
}


TEST_CASE("TryCatch, CreateArray_CreatesArray")
{
